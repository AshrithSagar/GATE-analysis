...
\begin{frame}{Resources}
    \begin{itemize}
        ...
        \item \textbf{NPTEL} lectures
        \item Books:
              \begin{itemize}
                  \item \textbf{Schaum's Series} \\
                        Signals and Systems, Analog and Digital Electronics
                  \item \textbf{BS Grewal}
                  \item \textbf{RS Khandpur} for Biomedical instrumentation
              \end{itemize}
    \end{itemize}
\end{frame}
